...
return [
    ...
    */
    ...
    "hashmatch"            => "Le mot de passe ne correspond pas à celui défini actuellement",
    "hashdiffer"           => "Le nouveau mot de passe doit être différent de celui défini actuellement",
    "phone"                => "Le format de téléphone fourni est incorrect (ex. : 06 51 25 85 42).",
    ...
    */
    ...
    'custom' => [
        'password' => [
            'regex' => 'Le mot de passe doit contenir au moins 8 caractères dont au moins un caractère alphabétique, un chiffre et un caractère spécial (@#$%)',
        ],
        'search' => [
            'exists' => 'Cette commande n’existe pas'
        ]
    ],
    ...
    */
    ...
    |
    */
   "alpha_num_spaces" => "Le champ :attribute doit uniquement contenir des lettres, chiffres et espaces",
   "alpha_spaces"     => "Le champ :attribute doit uniquement contenir des lettres et espaces"
